...
const BAKED = "C:\\Users\\buzbe\\AppData\\Roaming\\npm\\node_modules\\@nanonets\\graft\\dist\\claude";
...
// ponytail rozeti: graft satırının SOLUNA, senkron — graft main() zaten async.
// Rozet dosyası yoksa ya da ponytail kapalıysa hiçbir şey yazılmaz.
try {
  const b = require("C:/Users/buzbe/.claude/helpers/ponytail-badge.cjs").badge();
  if (b) process.stdout.write(b + " ");
} catch { /* ponytail yok — graft satırı tek başına basılır */ }
