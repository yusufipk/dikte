...
class Directories(unittest.TestCase):
    ...
    def test_windows_separates_roaming_settings_from_local_models(self):
        ...
        self.assertEqual(str(config_dir),
                         str(paths.pathlib.PureWindowsPath(
                             r"C:\Users\Ada\AppData\Roaming")
                             / "Dikte"))
        self.assertEqual(str(data_dir),
                         str(paths.pathlib.PureWindowsPath(
